...
def main():
    """ Generate a random name from 2 tuples """

    print("Welcome to the 'Random Name Generator' facility!")
    print("If you have trouble naming your pet, then we're here to help!")
